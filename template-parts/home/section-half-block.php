 ...
 */
	...
	$cat_id = intval( get_theme_mod( 'news_x_first_half_section_category_setting', 1 ) );
...
<div class="single-post-category block shadow">
	<div class="section-title-red">
		<span class="title"><?php echo esc_html( get_theme_mod( 'news_x_first_half_section_title_setting', 'News' ) ); ?></span>
...
$cat_id = intval( get_theme_mod( 'news_x_second_half_section_category_setting', 1 ) );
...
<div class="single-post-category block shadow">
	<div class="section-title-red">
		<span class="title"><?php echo esc_html( get_theme_mod( 'news_x_second_half_section_title_setting', 'News' ) ); ?></span>
	</div><!-- /.section-title-red -->
